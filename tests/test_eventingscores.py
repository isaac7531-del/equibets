...
"""
    ...
    def test_sunday_11utc_eight_nine_yo_cross_country_records_later_completers(self):
        eight_nine_board = EventingScoresBoard(
            url="https://www.eventingscores.co.uk/uploads/events/2990/results_2990_69244.html?eventid=2990",
            event_name="Blenheim · CCI4*-S 8/9YO",
            level="CCI4*-S",
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td></td>
          <td>Tom McEwen (GBR)</td>
          <td data-horse="SHANNONDALE ARNOLD" data-number="170"
              data-rider="Tom McEwen (GBR)">SHANNONDALE ARNOLD</td>
          <td class="score">32.9</td>
          <td class="score">4</td>
          <td class="score">9.6 in 7.18</td>
          <td class="score">0</td>
          <td class="score">46.5</td>
          <td>46th</td>
        </tr>
        <tr>
          <td>178</td>
        ...
        <tr>
          ...
          <td class="score">4</td>
          <td class="score">21.2 in 7.47</td>
          <td class="score">20</td>
          <td class="score">78.5</td>
          <td>77th</td>
        </tr>
        <tr>
          <td>169</td>
          <td></td>
          <td>Ella Howard (GBR)</td>
          <td data-horse="BRAVADO" data-number="169"
              data-rider="Ella Howard (GBR)">BRAVADO</td>
          <td class="score">47.9</td>
          <td class="score">0 + 2.4</td>
          <td class="score">51.2 in 9.02</td>
          <td class="score">40</td>
          <td class="score">141.5</td>
          <td>88th</td>
        </tr>
        <tr>
          <td>207</td>
...
"""
        eight_nine_results = parse_leaderboard_results(
            eight_nine_html,
            board=eight_nine_board,
            collected_at=datetime(2026, 9, 20, 11, 4, tzinfo=timezone.utc),
        )
        eight_nine_by_horse = {result.horse_name: result for result in eight_nine_results}
        self.assertEqual(len(eight_nine_results), 6)
        waiting_leader = eight_nine_by_horse["BROOKFIELD DANNY DE MUZE"]
        self.assertEqual(waiting_leader.show_jumping_penalties, 0.0)
        self.assertEqual(waiting_leader.cross_country_jump_penalties, 0.0)
        self.assertEqual(waiting_leader.cross_country_time_penalties, 0.0)
        self.assertEqual(waiting_leader.finishing_score, 27.2)
        time_only = eight_nine_by_horse["SHANNONDALE ARNOLD"]
        self.assertEqual(time_only.show_jumping_penalties, 4.0)
        self.assertEqual(time_only.cross_country_jump_penalties, 0.0)
        self.assertEqual(time_only.cross_country_time_penalties, 9.6)
        self.assertEqual(time_only.finishing_score, 46.5)
        rails_and_time = eight_nine_by_horse["AUCKLAND 7"]
        self.assertEqual(rails_and_time.show_jumping_penalties, 8.8)
        self.assertEqual(rails_and_time.cross_country_jump_penalties, 0.0)
        self.assertEqual(rails_and_time.cross_country_time_penalties, 14.0)
        self.assertEqual(rails_and_time.finishing_score, 49.7)
        jump_and_time = eight_nine_by_horse["OFF-WHITE ISAIE SAINT JEAN AA"]
        self.assertEqual(jump_and_time.show_jumping_penalties, 4.0)
        self.assertEqual(jump_and_time.cross_country_jump_penalties, 20.0)
        self.assertEqual(jump_and_time.cross_country_time_penalties, 21.2)
        self.assertEqual(jump_and_time.finishing_score, 78.5)
        heavy_faults = eight_nine_by_horse["BRAVADO"]
        self.assertEqual(heavy_faults.show_jumping_penalties, 2.4)
        self.assertEqual(heavy_faults.cross_country_jump_penalties, 40.0)
        self.assertEqual(heavy_faults.cross_country_time_penalties, 51.2)
        self.assertEqual(heavy_faults.finishing_score, 141.5)
        still_waiting = eight_nine_by_horse["KILROE TIGER"]
        self.assertEqual(still_waiting.show_jumping_penalties, 4.0)
        self.assertEqual(still_waiting.cross_country_jump_penalties, 0.0)
        self.assertEqual(still_waiting.cross_country_time_penalties, 0.0)
    ...
    def test_sunday_11utc_cci4_long_records_first_show_jumping(self):
        cci4_board = EventingScoresBoard(
            url="https://www.eventingscores.co.uk/uploads/events/2990/results_2990_69243.html?eventid=2990",
            event_name="Blenheim · CCI4*-L",
            level="CCI4*-L",
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td data-horse="BALLADEER CLINTENDER" data-number="10"
              data-rider="Elizabeth Power (IRL)">BALLADEER CLINTENDER</td>
          <td class="score">39.4</td>
          <td class="score">30.8 in 11.25</td>
          <td class="score">0</td>
        ...
        <tr>
          <td>41</td>
          <td></td>
          <td>Panda Christie (GBR)</td>
          <td data-horse="SIR VILLMER" data-number="41"
              data-rider="Panda Christie (GBR)">SIR VILLMER</td>
          <td class="score">39.7</td>
          <td class="score">48.8 in 12.10</td>
          <td class="score">20</td>
          <td class="score">8</td>
          <td class="score">116.5</td>
          <td>46th</td>
        </tr>
        <tr>
          <td>6</td>
          <td></td>
          <td>Katey Cuthbertson (GBR)</td>
          <td data-horse="INCOGNITO" data-number="6"
              data-rider="Katey Cuthbertson (GBR)">INCOGNITO</td>
          <td class="score">38.4</td>
          <td class="score">51.6 in 12.17</td>
          <td class="score">31</td>
          <td class="score">24 + 1.2</td>
          <td class="score">146.2</td>
          <td>50th</td>
        </tr>
      </tbody>
    </table>
...
"""
        ...
        cci4_by_horse = {result.horse_name: result for result in cci4_results}
        self.assertEqual(len(cci4_results), 5)
        waiting_leader = cci4_by_horse["THE FIELDMASTER"]
        self.assertEqual(waiting_leader.show_jumping_penalties, 0.0)
        self.assertEqual(waiting_leader.cross_country_jump_penalties, 0.0)
        self.assertEqual(waiting_leader.cross_country_time_penalties, 1.2)
        self.assertEqual(waiting_leader.finishing_score, 30.4)
        rails_and_time = cci4_by_horse["BALLADEER CLINTENDER"]
        self.assertEqual(rails_and_time.show_jumping_penalties, 5.2)
        self.assertEqual(rails_and_time.cross_country_jump_penalties, 0.0)
        self.assertEqual(rails_and_time.cross_country_time_penalties, 30.8)
        self.assertEqual(rails_and_time.finishing_score, 75.4)
        time_only = cci4_by_horse["MASTER QUALITY IMP"]
        self.assertEqual(time_only.show_jumping_penalties, 0.4)
        self.assertEqual(time_only.cross_country_jump_penalties, 20.0)
        self.assertEqual(time_only.cross_country_time_penalties, 27.6)
        self.assertEqual(time_only.finishing_score, 84.5)
        rails_only = cci4_by_horse["SIR VILLMER"]
        self.assertEqual(rails_only.show_jumping_penalties, 8.0)
        self.assertEqual(rails_only.cross_country_jump_penalties, 20.0)
        self.assertEqual(rails_only.cross_country_time_penalties, 48.8)
        self.assertEqual(rails_only.finishing_score, 116.5)
        heavy_compound = cci4_by_horse["INCOGNITO"]
        self.assertEqual(heavy_compound.show_jumping_penalties, 25.2)
        self.assertEqual(heavy_compound.cross_country_jump_penalties, 31.0)
        self.assertEqual(heavy_compound.cross_country_time_penalties, 51.6)
        self.assertEqual(heavy_compound.finishing_score, 146.2)

    def test_sunday_12utc_eight_nine_yo_cross_country_records_later_completers(self):
        eight_nine_board = EventingScoresBoard(
            url="https://www.eventingscores.co.uk/uploads/events/2990/results_2990_69244.html?eventid=2990",
            event_name="Blenheim · CCI4*-S 8/9YO",
            level="CCI4*-S",
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>203</td>
          <td></td>
          <td>Kaitlyn Freeman (NZL)</td>
          <td data-horse="NEVER KNOW MB" data-number="203"
              data-rider="Kaitlyn Freeman (NZL)">NEVER KNOW MB</td>
          <td class="score">39.6</td>
          <td class="score">0 + 0.4</td>
          <td class="score">7.2 in 7.12</td>
          <td class="score">0</td>
          <td class="score">47.2</td>
          <td>47th</td>
        </tr>
        <tr>
          <td>192</td>
          <td></td>
          <td>Cosby Green (USA)</td>
          <td data-horse="MBF PARTY TIME" data-number="192"
              data-rider="Cosby Green (USA)">MBF PARTY TIME</td>
          <td class="score">38.1</td>
          <td class="score">0 + 1.2</td>
          <td class="score">13.2 in 7.27</td>
          <td class="score">0</td>
          <td class="score">52.5</td>
          <td>52nd</td>
        </tr>
        <tr>
          <td>204</td>
          <td></td>
          <td>Ricardo Montalvo (ESP)</td>
          <td data-horse="HK DOMINATE" data-number="204"
              data-rider="Ricardo Montalvo (ESP)">HK DOMINATE</td>
          <td class="score">39.2</td>
          <td class="score">8</td>
          <td class="score">32 in 8.14</td>
          <td class="score">0</td>
          <td class="score">79.2</td>
          <td>79th</td>
        </tr>
        <tr>
          <td>196</td>
          ...
          <td class="score">29.6 in 8.08</td>
          <td class="score">11</td>
          <td class="score">86.7</td>
          <td>86th</td>
        </tr>
        <tr>
          <td>207</td>
...
"""
        eight_nine_results = parse_leaderboard_results(
            eight_nine_html,
            board=eight_nine_board,
            collected_at=datetime(2026, 9, 20, 12, 4, tzinfo=timezone.utc),
        )
        eight_nine_by_horse = {result.horse_name: result for result in eight_nine_results}
        self.assertEqual(len(eight_nine_results), 6)
        waiting_leader = eight_nine_by_horse["BROOKFIELD DANNY DE MUZE"]
        ...
        self.assertEqual(waiting_leader.cross_country_time_penalties, 0.0)
        self.assertEqual(waiting_leader.finishing_score, 27.2)
        time_only = eight_nine_by_horse["NEVER KNOW MB"]
        self.assertEqual(time_only.show_jumping_penalties, 0.4)
        self.assertEqual(time_only.cross_country_jump_penalties, 0.0)
        self.assertEqual(time_only.cross_country_time_penalties, 7.2)
        self.assertEqual(time_only.finishing_score, 47.2)
        rails_and_time = eight_nine_by_horse["MBF PARTY TIME"]
        self.assertEqual(rails_and_time.show_jumping_penalties, 1.2)
        self.assertEqual(rails_and_time.cross_country_jump_penalties, 0.0)
        self.assertEqual(rails_and_time.cross_country_time_penalties, 13.2)
        self.assertEqual(rails_and_time.finishing_score, 52.5)
        heavy_time = eight_nine_by_horse["HK DOMINATE"]
        self.assertEqual(heavy_time.show_jumping_penalties, 8.0)
        self.assertEqual(heavy_time.cross_country_jump_penalties, 0.0)
        self.assertEqual(heavy_time.cross_country_time_penalties, 32.0)
        self.assertEqual(heavy_time.finishing_score, 79.2)
        jump_and_time = eight_nine_by_horse["BLACK SWAN DECANDIE Z"]
        self.assertEqual(jump_and_time.show_jumping_penalties, 16.0)
        self.assertEqual(jump_and_time.cross_country_jump_penalties, 11.0)
        self.assertEqual(jump_and_time.cross_country_time_penalties, 29.6)
        self.assertEqual(jump_and_time.finishing_score, 86.7)
        still_waiting = eight_nine_by_horse["KILROE TIGER"]
        self.assertEqual(still_waiting.show_jumping_penalties, 4.0)
        self.assertEqual(still_waiting.cross_country_jump_penalties, 0.0)
        self.assertEqual(still_waiting.cross_country_time_penalties, 0.0)
    ...
    def test_sunday_12utc_cci4_long_records_later_show_jumping(self):
        cci4_board = EventingScoresBoard(
            url="https://www.eventingscores.co.uk/uploads/events/2990/results_2990_69243.html?eventid=2990",
            event_name="Blenheim · CCI4*-L",
            level="CCI4*-L",
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="score">0</td>
          <td class="score">4</td>
          <td class="score">51.9</td>
          <td>19th</td>
        </tr>
        <tr>
          <td>42</td>
          <td></td>
          <td>Grace Taylor (USA)</td>
          <td data-horse="BANDITO VAN POLDERZICHT" data-number="42"
              data-rider="Grace Taylor (USA)">BANDITO VAN POLDERZICHT</td>
          <td class="score">40.2</td>
          <td class="score">17.6 in 10.52</td>
          <td class="score">0</td>
          <td class="score">0 + 1.2</td>
          <td class="score">59.0</td>
          <td>22nd</td>
        </tr>
        <tr>
          <td>1</td>
        ...
        <tr>
          ...
          <td></td>
          <td>Rafael Losano (BRA)</td>
          <td data-horse="BRINDLEY'S FINALE" data-number="4"
              data-rider="Rafael Losano (BRA)">BRINDLEY'S FINALE</td>
          <td class="score">40.8</td>
          <td class="score">20.8 in 11.00</td>
          <td class="score">11</td>
          <td class="score">4 + 0.8</td>
...
"""
        ...
        self.assertEqual(waiting_leader.cross_country_time_penalties, 1.2)
        self.assertEqual(waiting_leader.finishing_score, 30.4)
        rails_only = cci4_by_horse["BARRINGTON REVELATION"]
        self.assertEqual(rails_only.show_jumping_penalties, 4.0)
        self.assertEqual(rails_only.cross_country_jump_penalties, 0.0)
        self.assertEqual(rails_only.cross_country_time_penalties, 8.0)
        self.assertEqual(rails_only.finishing_score, 51.9)
        time_only = cci4_by_horse["BANDITO VAN POLDERZICHT"]
        self.assertEqual(time_only.show_jumping_penalties, 1.2)
        self.assertEqual(time_only.cross_country_jump_penalties, 0.0)
        self.assertEqual(time_only.cross_country_time_penalties, 17.6)
        self.assertEqual(time_only.finishing_score, 59.0)
        rails_and_xc = cci4_by_horse["COOLEY STIRLING"]
        self.assertEqual(rails_and_xc.show_jumping_penalties, 4.0)
        self.assertEqual(rails_and_xc.cross_country_jump_penalties, 11.0)
        self.assertEqual(rails_and_xc.cross_country_time_penalties, 8.4)
        self.assertEqual(rails_and_xc.finishing_score, 60.8)
        compound = cci4_by_horse["BRINDLEY'S FINALE"]
        self.assertEqual(compound.show_jumping_penalties, 4.8)
        self.assertEqual(compound.cross_country_jump_penalties, 11.0)
...
"""
    ...
    def test_sunday_14utc_eight_nine_yo_cross_country_records_final_completers(self):
        eight_nine_board = EventingScoresBoard(
            url="https://www.eventingscores.co.uk/uploads/events/2990/results_2990_69244.html?eventid=2990",
            event_name="Blenheim · CCI4*-S 8/9YO",
            level="CCI4*-S",
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="score">27.4</td>
          <td class="score">0</td>
          <td class="score">6 in 7.09</td>
          <td class="score">11</td>
          <td class="score">44.4</td>
          <td>15th</td>
        </tr>
        <tr>
          <td>214</td>
        ...
        <tr>
          ...
          <td></td>
          <td>Therese Viklund (SWE)</td>
          <td data-horse="SELLA" data-number="117"
              data-rider="Therese Viklund (SWE)">SELLA</td>
          <td class="score">29.1</td>
          <td class="score">0</td>
          <td></td>
          <td>RET</td>
...
"""
        eight_nine_results = parse_leaderboard_results(
            eight_nine_html,
            board=eight_nine_board,
            collected_at=datetime(2026, 9, 20, 14, 4, tzinfo=timezone.utc),
        )
        eight_nine_by_horse = {result.horse_name: result for result in eight_nine_results}
        self.assertEqual(len(eight_nine_results), 6)
        time_only_leader = eight_nine_by_horse["BROOKFIELD DANNY DE MUZE"]
        self.assertEqual(time_only_leader.show_jumping_penalties, 0.0)
        self.assertEqual(time_only_leader.cross_country_jump_penalties, 0.0)
        self.assertEqual(time_only_leader.cross_country_time_penalties, 2.0)
        self.assertEqual(time_only_leader.finishing_score, 29.2)
        later_time_only = eight_nine_by_horse["CUSHLAS INDIGO"]
        self.assertEqual(later_time_only.show_jumping_penalties, 0.0)
        self.assertEqual(later_time_only.cross_country_jump_penalties, 0.0)
        self.assertEqual(later_time_only.cross_country_time_penalties, 2.8)
        self.assertEqual(later_time_only.finishing_score, 31.2)
        sj_then_time = eight_nine_by_horse["SANCERRE DE TIJI"]
        self.assertEqual(sj_then_time.show_jumping_penalties, 0.4)
        self.assertEqual(sj_then_time.cross_country_jump_penalties, 0.0)
        self.assertEqual(sj_then_time.cross_country_time_penalties, 4.4)
        self.assertEqual(sj_then_time.finishing_score, 31.7)
        jump_and_time = eight_nine_by_horse["BARRINGTON BOY"]
        self.assertEqual(jump_and_time.show_jumping_penalties, 0.0)
        self.assertEqual(jump_and_time.cross_country_jump_penalties, 11.0)
        self.assertEqual(jump_and_time.cross_country_time_penalties, 6.0)
        self.assertEqual(jump_and_time.finishing_score, 44.4)
        heavy_time = eight_nine_by_horse["KILCOLTRIM COOLEY"]
        self.assertEqual(heavy_time.show_jumping_penalties, 0.0)
        self.assertEqual(heavy_time.cross_country_jump_penalties, 0.0)
        self.assertEqual(heavy_time.cross_country_time_penalties, 17.6)
        self.assertEqual(heavy_time.finishing_score, 45.4)
        retired = eight_nine_by_horse["SELLA"]
        self.assertEqual(retired.show_jumping_penalties, 0.0)
        self.assertEqual(retired.cross_country_jump_penalties, 0.0)
        self.assertEqual(retired.cross_country_time_penalties, 0.0)
        self.assertEqual(retired.finishing_score, 29.1)

    def test_sunday_14utc_cci4_long_records_later_show_jumping(self):
        cci4_board = EventingScoresBoard(
            url="https://www.eventingscores.co.uk/uploads/events/2990/results_2990_69243.html?eventid=2990",
            event_name="Blenheim · CCI4*-L",
            level="CCI4*-L",
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>27</td>
          <td></td>
          <td>Olivia Dutton (USA)</td>
          <td data-horse="JEWELENT" data-number="27"
              data-rider="Olivia Dutton (USA)">JEWELENT</td>
          <td class="score">32.9</td>
          <td class="score">13.6 in 10.42</td>
          <td class="score">0</td>
          <td class="score">0 + 0.8</td>
          <td class="score">47.3</td>
          <td>17th</td>
        </tr>
        <tr>
          <td>78</td>
...
"""
        ...
        time_only = cci4_by_horse["JACKPOT"]
        self.assertEqual(time_only.show_jumping_penalties, 0.4)
        self.assertEqual(time_only.cross_country_jump_penalties, 0.0)
        self.assertEqual(time_only.cross_country_time_penalties, 5.2)
        self.assertEqual(time_only.finishing_score, 38.0)
        later_time_only = cci4_by_horse["JEWELENT"]
        self.assertEqual(later_time_only.show_jumping_penalties, 0.8)
        self.assertEqual(later_time_only.cross_country_jump_penalties, 0.0)
        self.assertEqual(later_time_only.cross_country_time_penalties, 13.6)
        self.assertEqual(later_time_only.finishing_score, 47.3)
        rails_and_time = cci4_by_horse["LSS ILE DE RE"]
        self.assertEqual(rails_and_time.show_jumping_penalties, 4.4)
        self.assertEqual(rails_and_time.cross_country_jump_penalties, 0.0)
        self.assertEqual(rails_and_time.cross_country_time_penalties, 11.2)
        self.assertEqual(rails_and_time.finishing_score, 51.6)
        rails_only = cci4_by_horse["BALANCERO"]
        self.assertEqual(rails_only.show_jumping_penalties, 4.0)
        self.assertEqual(rails_only.cross_country_jump_penalties, 0.0)
