...
class EventSourceTests(unittest.TestCase):
    def test_data_fei_is_primary_source(self):
        ...
        self.assertEqual(sources[0].event_levels, ("all_fei_international_levels",))
    ...
    def test_specific_country_lookup_keeps_national_source(self):
    ...
    def test_global_national_source_covers_all_countries_and_levels(self):
        ...
        self.assertEqual(global_source.event_levels, ("all_published_national_levels",))
