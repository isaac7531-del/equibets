...
class EventSourceTests(unittest.TestCase):
    def test_registry_tracks_all_country_all_level_coverage(self):
        ...
        self.assertEqual(
            payload["coverage_goal"],
            "Collect eventing results for all countries and all eventing levels, "
            "prioritizing data.fei and supplementing with national-event sources.",
        )
        global_source = next(
            source
