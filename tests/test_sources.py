...
class EventSourceTests(unittest.TestCase):
    ...
    def test_every_declared_country_has_fei_and_national_backfill(self):
        registry = load_event_source_registry()
    ...
    def test_every_declared_level_has_matching_sources(self):
        registry = load_event_source_registry()

        for event_level in registry.coverage_targets.fei_levels:
        ...
        for event_level in registry.coverage_targets.national_and_regional_levels:
            with self.subTest(event_level=event_level):
