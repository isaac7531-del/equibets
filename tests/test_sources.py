...
class EventSourceTests(unittest.TestCase):
    ...
    def test_country_lookup_routes_to_regional_and_priority_sources(self):
        country_expectations = {
            "GB": ("europe_national_federations", "british_eventing"),
            "GBR": ("europe_national_federations", "british_eventing"),
            "UK": ("europe_national_federations", "british_eventing"),
            "US": ("north_america_national_federations", "usea"),
            ...
            "BHR": ("middle_east_national_federations",),
            "BRN": ("middle_east_national_federations",),
            "SAU": ("middle_east_national_federations",),
