...
2. National-event sources fill gaps after FEI data, with regional coverage for
   Africa, Asia, Europe, the Middle East, the Americas, and Oceania, plus
   country-specific priority sources for the UK, Australia, New Zealand, and the
   USA.
3. `global_national_federations` is the backfill path for national events from
   every country and every recognized national level after the priority regions
   are covered.
