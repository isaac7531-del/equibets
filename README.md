...
`sources_for_region()` for regional planning, `sources_for_country()` for a
country code plus global fallbacks, and `sources_for_event_level()` for
level-specific source routing.
