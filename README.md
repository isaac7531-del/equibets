...
Use `sources_for_country(country, level=...)` when a refresh needs national
sources for a specific country and eventing level. Use `sources_for_region(...)`
for regional refresh jobs.
