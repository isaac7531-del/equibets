...
2. National-event sources fill gaps after FEI data across every country and
   every competition level.
3. Region-specific adapters for Europe, the UK, Australia, New Zealand, and the
   USA stay ahead of the global backfill when they provide richer coverage.
4. `global_national_federations` is the backfill path for national events from
   every country and all levels after higher-priority adapters are covered.
