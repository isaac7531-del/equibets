...
3. Regional national-federation registries broaden coverage across Europe, the
   Americas, Asia, Africa, and Oceania.
4. `global_national_federations` is the backfill path for national events from
   every country and every normalized national level after the priority regions
   are covered.
