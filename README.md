...
`equibets.sources`. It declares all countries and all eventing levels as in
scope for national-event coverage.
...
2. National-event sources fill gaps after FEI data, with priority coverage for
   Europe, the UK, Australia, New Zealand, and the USA across every domestic
   eventing level.
