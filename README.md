...
2. National-event sources fill gaps after FEI data at every national level:
   national championship, national, regional, local, grassroots, training, and
   youth/pony.
3. Priority national coverage starts with Europe, the UK, Australia, New
   Zealand, and the USA, then expands through North America, Central
...
4. `global_national_federations` is the backfill path for national events from
   every FEI member nation and every national event level after priority regions
   are covered.
