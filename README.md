...
2. National-event sources fill gaps after FEI data across every configured
   national level, from championships and advanced classes through grassroots,
   regional, and unaffiliated starts.
3. Priority national coverage remains Europe, the UK, Australia, New Zealand,
   and the USA.
