...
- Tracks public event-results sources for FEI and national-event coverage across
  all FEI member nations and levels.
...
2. National-event sources fill gaps after FEI data across national, regional,
   local, grassroots, and schooling levels.
3. Europe, the UK, Australia, New Zealand, and the USA remain higher-priority
   national-event regions.
