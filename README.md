...
2. National-event sources fill gaps after FEI data for Africa, Asia, Europe,
   the Middle East, North America, South America, and Oceania, with
   country-specific priority feeds for Great Britain, Australia, New Zealand,
   and the USA.
3. The registry declares domestic levels from starter through national
   five-star plus FEI international, CCI, and championship levels.
4. `global_national_federations` is the backfill path for national events from
   every FEI member nation and every domestic level after the priority regions
   are covered.
