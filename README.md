...
2. National-event sources fill gaps after FEI data across regional federation
   registries for Europe, North America, South America, the Middle East, Africa,
   Asia, and Oceania.
3. Country-specific feeds for Great Britain, Australia, New Zealand, and the USA
   override regional registries where they expose richer domestic classes.
