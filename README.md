...
1. `data_fei` (`https://data.fei.org/`) is the primary source for eventing
   results across all 135 FEI National Federations.
2. National-event sources fill gaps after FEI data across domestic championship,
   national, regional, state/provincial, local, club, grassroots, youth/pony,
   and schooling/training levels, with priority coverage for Europe, the UK,
