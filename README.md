...
2. Regional national-federation registries fill domestic-level gaps across
   Africa, Asia, Europe, the Middle East, North America, South America, and
   Oceania, with dedicated high-priority sources for the UK, Australia, New
   Zealand, and the USA.
3. `global_national_federations` is the backfill path for every FEI member
   nation and every national or regional eventing level after higher-priority
   sources are covered.
