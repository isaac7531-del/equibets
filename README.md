...
2. Regional national-federation registries fill national-event gaps across
   Europe, Africa, Asia, the Middle East, North America, Central America and the
   Caribbean, South America, and Oceania.
3. Country-specific sources for the UK, Australia, New Zealand, and the USA stay
   prioritized where richer national-event portals are known.
4. `global_national_federations` is the backfill path for national events from
   every FEI member nation across every configured national level.
