...
2. `global_national_federations` covers national events from every FEI member
   nation at every national-event level.
3. Country and region-specific sources enrich that global national-event
   coverage where dedicated public results portals are available.
