...
2. National-event sources fill gaps after FEI data across all countries with
   eventing coverage and all national or FEI-equivalent levels.
3. Direct national federation sources remain prioritized for Europe, the UK,
   Australia, New Zealand, and the USA.
4. `global_national_federations` is the backfill path for national events from
   every country and every eventing level after direct sources are covered.
