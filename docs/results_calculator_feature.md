...
- Track every country and every configured eventing level over time, while
  prioritizing richer named national-event data from the UK, Australia, New
  Zealand, and the USA.
...
2. Pull national-event updates from named priority federations and regional
