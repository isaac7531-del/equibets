...
1. Refresh public data weekly from `data/event_sources.json`, selecting national
   sources by country and level.
...
2. Pull national-event updates from the priority regions and their configured
   all-level national sources.
