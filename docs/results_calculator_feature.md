...
- Track national-event data from all countries and all competition levels over
  time, while still preferring richer country or region adapters when available.
...
2. Pull national-event updates from country or region adapters where available.
3. Pull global national-federation results for all countries and levels as a
   backfill.
