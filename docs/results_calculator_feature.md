...
- Track all countries and domestic event levels over time, while prioritizing
...
2. Pull national-event updates from the priority regions across the configured
   national level taxonomy.
