...
- Track every FEI member nation over time, including national-event data from
  every eventing level exposed by federation portals.
...
2. Pull global national-federation updates for all FEI member nations and all
   eventing levels.
3. Pull regional and country-specific portal integrations where available.
