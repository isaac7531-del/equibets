...
- Track every FEI member nation over time, with national-event data organized by
  region and domestic level.
...
1. Pull new international FEI results from `data.fei.org`.
2. Pull national-event updates from regional and country-specific sources.
