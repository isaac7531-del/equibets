...
- Track all 135 FEI National Federations over time, while prioritizing richer
...
2. Pull national-event updates from the priority regions across championship,
   national, regional, state/provincial, local, club, grassroots, youth/pony,
   and schooling/training levels.
3. Pull global national-federation results as a backfill for all FEI countries.
