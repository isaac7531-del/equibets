...
- Track all nations over time, including national-event data from every FEI
  member country and every national, regional, state/provincial, local, club,
  grassroots, and schooling level.
...
2. Pull national-event updates from known national and continental federation
   sources.
