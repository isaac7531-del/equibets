...
- Track national-event data from every country and every eventing level, while
  still prioritizing richer known sources from Europe, the UK, Australia, New
  Zealand, and the USA.
...
2. Pull national-event updates for the requested country and level.
3. Pull global all-country national-federation results as a backfill.
