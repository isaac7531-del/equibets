...
- Track all nations and every national eventing level over time, while
...
2. Pull national-event updates from the priority regions across every national
   eventing level.
3. Pull global national-federation results from every FEI member nation as a
   backfill.
