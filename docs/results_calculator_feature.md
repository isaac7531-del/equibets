...
- Track every country and every published event level over time, while still
  prioritizing richer national-event data where dedicated sources exist.
...
2. Pull national-event updates from dedicated country or regional sources.
