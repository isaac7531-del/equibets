...
- Track all nations over time, while prioritizing richer national-event data
  from Europe, the UK, Australia, New Zealand, and the USA before regional and
  global national-federation backfills.
...
2. Pull national-event updates from the priority regions across every declared
   national level.
3. Pull regional national-federation updates for the remaining world regions.
