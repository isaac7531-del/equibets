...
- Track all nations over time, including national-event results from every FEI
  member nation and every national eventing level.
...
2. Pull country-specific national-event updates where direct sources exist.
3. Pull regional and global national-federation results as a backfill for every
   country and every national level.
