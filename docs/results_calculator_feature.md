...
- Track all nations and event levels over time, while prioritizing richer
...
2. Pull national-event updates from the priority regions across national,
   regional, local, and grassroots levels.
3. Pull global national-federation results as a backfill for every FEI member
   nation and every national-event level.
