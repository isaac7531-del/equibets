...
- Track all countries over time, including national-event results from every
  eventing level where public or federation data is available.
...
2. Pull global national-federation and public national-event results for every
   country and all configured national eventing levels.
3. Pull continent and named national-source updates where dedicated result
