...
2. Pull national-event updates from the priority regions across every domestic
   eventing level.
3. Pull global national-federation results as a backfill for every remaining
