...
2. Pull national-event updates from the priority regions and continent-level
   federation registries.
3. Pull global all-country, all-level national-federation results as a backfill.
