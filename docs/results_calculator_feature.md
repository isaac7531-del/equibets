...
- Track all nations over time, with national-event data from every country and
  every event level.
...
2. Pull national-event updates from direct national federation sources.
3. Pull regional and global national-federation results as a backfill.
