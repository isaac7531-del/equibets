...
- Track all countries and eventing levels over time, while prioritizing richer national-event data
...
2. Pull national-event updates from the priority regions across all eventing levels.
