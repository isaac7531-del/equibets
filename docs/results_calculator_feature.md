...
- Track all countries and national-event levels over time, while prioritizing
  richer national-event data from Europe, the UK, Australia, New Zealand, and
  the USA before broader regional and global backfills.
...
2. Pull national-event updates from the priority regions and all national-event
   levels.
3. Pull continent-level and global national-federation results as backfills for
   every country.
