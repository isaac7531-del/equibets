...
- Track all nations and levels over time, while prioritizing richer
  national-event data from regional registries and known country portals.
...
2. Pull national-event updates from regional national-federation registries.
3. Pull known country-specific national portals for richer local coverage.
