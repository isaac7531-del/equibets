...
- Track all FEI member nations over time, while prioritizing richer national-
  event data from regional federation registries plus the UK, Australia, New
  Zealand, and the USA.
...
2. Pull national-event updates from the configured regional federation
   registries for Africa, Asia, Europe, the Middle East, North America, Central
   America and the Caribbean, South America, and Oceania.
3. Pull priority national-event sources for the UK, Australia, New Zealand, and
   the USA.
4. Pull global national-federation results as a backfill for every FEI member
   nation and configured domestic level.
