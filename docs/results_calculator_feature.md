...
- Track every FEI member nation and every configured eventing level over time,
  while prioritizing richer national-event data from Europe, the UK, Australia,
...
2. Pull national-event updates from the priority regions: Europe, the UK,
   Australia, New Zealand, and the USA.
3. Pull additional regional national-federation updates for North America,
