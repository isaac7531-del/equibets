...
- Track all nations and national-event levels over time, while prioritizing
  richer regional and country-specific sources where available.
...
2. Pull national-event updates from regional and country-specific priority sources.
3. Pull global national-federation results for every country and recognized
   national level as a backfill.
