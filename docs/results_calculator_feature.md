...
- Track national-event data for every FEI member nation and every national
  event level, while enriching coverage with country-specific result portals.
...
2. Pull global national-federation results for all FEI member nations and
   national event levels.
3. Pull country and region-specific national-event updates as enrichments.
