...
- Track every country over time, including national-event data from every
...
2. Pull national-event updates from country or region-specific connectors when
   they provide richer coverage.
3. Pull global national-federation results as the all-country, all-level
   backfill.
