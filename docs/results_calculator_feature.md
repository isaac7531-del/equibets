...
- Track all countries and national eventing levels over time, while
...
2. Pull national-event updates from the priority regions across championship,
   national, regional, local, grassroots, training, schooling, youth, and
   pony-club levels.
3. Pull global national-federation results as an all-country backfill.
