...
- Track national-event data for all countries and eventing levels over time,
  while prioritizing richer national sources from Europe, the UK, Australia,
...
2. Pull national-event updates from the priority regions across all eventing
   levels.
