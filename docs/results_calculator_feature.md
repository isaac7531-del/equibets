...
- Track all nations over time, including national-event data from every country
  and every competition level.
...
2. Pull national-event updates from all configured country-specific sources.
3. Pull global national-federation results for any country and level not covered
   by direct sources.
