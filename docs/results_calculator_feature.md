...
- Track all FEI member nations over time, while prioritizing richer
  national-event data from regional registries and dedicated portals in the UK,
...
2. Pull national-event updates from regional federation registries for Africa,
   Asia, Europe, the Middle East, North America, South America, and Oceania.
3. Pull dedicated national portals for the UK, Australia, New Zealand, and the
   USA where they provide deeper eventing coverage.
