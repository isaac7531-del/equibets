...
- Track every country and eventing level over time, while prioritizing richer
...
2. Pull national-event updates from the priority regions across all supported
   eventing levels.
