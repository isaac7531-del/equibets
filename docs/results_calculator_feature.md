...
- Track every FEI member nation and all national-event levels over time, while
  using direct national-federation connectors where available.
...
2. Pull national-event updates from configured country and regional connectors.
3. Pull global national-federation results for every country and national level
   not covered by a direct connector.
