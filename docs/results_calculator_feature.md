...
- Track every FEI member nation over time, including national-event data from
  national championship, elite/advanced, intermediate, preliminary, training,
  novice, introductory, regional, local, club, grassroots, schooling, starter,
  and pony/youth levels.
...
2. Pull national-event updates from priority region and country connectors.
3. Pull global national-federation results as an all-country, all-level
   backfill.
