...
- Track all nations and levels over time, while prioritizing richer direct
...
2. Pull direct national-event updates from the priority regions.
3. Pull global national-federation results as a backfill for every country and
   every national or FEI-equivalent level.
