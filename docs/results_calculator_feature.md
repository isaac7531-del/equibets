...
- Track all FEI member nations over time, covering FEI international classes and
  national, regional, and domestic eventing levels through regional federation
  registries plus country-specific priority sources.
...
2. Pull national-event updates from regional national-federation registries for
   Africa, Asia, Europe, the Middle East, North America, Central America and the
   Caribbean, South America, and Oceania.
3. Pull country-specific priority sources for the UK, Australia, New Zealand,
   and the USA.
4. Pull global national-federation results as a backfill for every FEI member
   nation and declared domestic level.
