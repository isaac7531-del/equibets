...
- Track national-event results for every country and every eventing level over
  time, while prioritizing richer data from Europe, the UK, Australia, New
  Zealand, and the USA.
...
2. Pull national-event updates from priority country and region sources across
   every eventing level.
3. Pull global national-federation results for every country and level as a
   backfill.
