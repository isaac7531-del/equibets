...
- Track all countries and eventing levels over time, while prioritizing richer
  national-event data from regional federation registries and country-specific
  sources for the UK, Australia, New Zealand, and the USA.
...
2. Pull national-event updates from the priority regions across every target
   national level.
