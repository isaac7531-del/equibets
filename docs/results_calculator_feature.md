...
2. Pull national-event updates for all eventing levels from the priority regions.
3. Pull global national-federation results for every country as a backfill.
