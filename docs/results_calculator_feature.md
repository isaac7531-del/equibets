...
- Track all FEI member nations over time, across FEI international events and
  national, regional, local, grassroots, and schooling levels, while
...
2. Pull national-event updates from the priority regions across all configured
   national-event levels.
3. Pull global national-federation results as a backfill for every FEI member
   nation and national-event level.
