...
- Track all nations and national eventing levels over time, while prioritizing
...
3. Pull global national-federation results for every remaining FEI member nation
   and national eventing level as a backfill.
