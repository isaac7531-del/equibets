...
- Track every configured FEI country code over time, while prioritizing richer
...
2. Pull national-event updates from the priority regions across every configured
   national level.
