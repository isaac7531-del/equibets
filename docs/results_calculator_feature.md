...
- Track every country and configured eventing level over time, while
  prioritizing richer national-event data from regional federation registries
...
2. Pull national-event updates from the regional federation registries.
3. Pull country-priority national sources for the UK, Australia, New Zealand,
   and the USA.
4. Pull global national-federation results as the all-country, all-level
   backfill.
