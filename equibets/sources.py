...
ALL_EVENT_LEVEL_MARKERS = frozenset({"all_eventing_levels"})
...
def _covers_level(source: EventSource, level: str | None) -> bool:
    ...
    levels = {_normalize_slug(event_level) for event_level in source.event_levels}
    return bool(levels & ALL_EVENT_LEVEL_MARKERS) or _normalize_slug(level) in levels
