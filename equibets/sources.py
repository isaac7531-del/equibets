...
class CoverageTargets:
    """Coverage goals shared by every configured event-results source."""
    ...
    def event_levels(self) -> tuple[str, ...]:
        """Return every configured event level in domestic-then-international order."""
...
class EventSourceRegistry:
    """Loaded event-results source registry and its coverage targets."""
    ...
    def primary_source(self) -> EventSource:
        """Return the configured primary source."""
...
def load_event_source_registry(path: Path | str = DATA_FILE) -> EventSourceRegistry:
    """Load the event-results source registry."""
