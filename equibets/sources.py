...
def _covers_country(source: EventSource, normalized_country: str) -> bool:
    ...
    wildcard_countries = {_normalize_key(country) for country in source.countries}
    return bool(COUNTRY_WILDCARDS & wildcard_countries) or normalized_country in source_countries
...
def _covers_level(source: EventSource, level: str | None) -> bool:
    ...
    source_levels = {_normalize_key(source_level) for source_level in source.event_levels}
