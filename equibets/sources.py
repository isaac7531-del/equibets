...
def _covers_country(source: EventSource, normalized_country: str) -> bool:
    country_tokens = {_normalized_token(country) for country in source.countries}
    country_codes = {country.upper() for country in source.countries}
    return ALL_COUNTRIES in country_tokens or normalized_country in country_codes
...
def _covers_level(source: EventSource, level: str | None) -> bool:
    ...
    source_levels = {_normalized_token(source_level) for source_level in source.event_levels}
