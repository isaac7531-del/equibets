...
def _source_covers_country(source: EventSource, normalized_country: str) -> bool:
    normalized_countries = {_normalize_country(country) for country in source.countries}
    return bool(
        ALL_COUNTRY_MARKERS.intersection(normalized_countries)
...
def _source_covers_level(source: EventSource, level: str | None) -> bool:
    ...
    return ALL_LEVEL_MARKER in normalized_levels or normalized_level in normalized_levels
