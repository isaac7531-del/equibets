...
def sources_for_region(
    ...
    *,
    ...
    """Return sources covering a region and optional level by global priority."""
...
def _covers_country(source: EventSource, normalized_country: str) -> bool:
    ...
    return (
        _normalize_country(ALL_COUNTRIES) in countries
...
def _covers_level(source: EventSource, level: str | None) -> bool:
    ...
    return (
        _normalize_token(ALL_EVENTING_LEVELS) in levels
