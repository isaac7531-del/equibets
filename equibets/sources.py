...
def sources_for_country(
    ...
    *,
    ...
    """Return sources covering a country and optional event level by priority."""
...
def _covers_country(source: EventSource, normalized_country: str) -> bool:
    ...
    return bool(COUNTRY_WILDCARDS & source_countries) or normalized_country in source_countries
...
def _covers_level(source: EventSource, level: str | None) -> bool:
    ...
    return bool(LEVEL_WILDCARDS & source_levels) or _normalize_level(level) in source_levels
